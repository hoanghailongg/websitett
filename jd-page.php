...
<div class="container-fluid fluid-nav another-page">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto tnav-left tn-nav">
      <li class="nav-item">
        <a class="nav-link" href="search.php">Việc Làm IT</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="search.php">Tin Tức</a>
      </li>
    ...
    <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="login-employees.php">Đăng Ký</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link btn-employers" href="login-employers.php" tabindex="-1" aria-disabled="true" style="color: #fff!important">Nhà Tuyển Dụng</a>
      </li>
    </ul>
  </div>
</nav>
      ...
      <div class="row">
        ...
        <div class="col-md-7 col-sm-12 col-12">
          <div class="job-detail-header-desc">
              ...
              <div class="job-detail-header-de">
                <ul>
                  <li><i class="fa fa-map-marker icn-jd"></i><span>Hà Nội</span></li>
                  <li><i class="fa fa-usd icn-jd"></i><span>15 triệu - 20 triệu</span></li>
                  <li><i class="fa fa-calendar icn-jd"></i><span>15/01/2023</span></li>
                </ul>
              </div>
        ...
        <div class="col-md-3 col-sm-12 col-12">
          <div class="jd-header-wrap-right">
            <div class="jd-center">
              <input class="btn btn-primary btn-apply" type="button" value="Nộp Đơn" onclick="alert('Nộp Đơn Thành Công!');"/>
          ...
          <div class="job-info-wrap">
            <div class="job-info-list">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <span class="ji-main">Hà Nội</span>
                </div>
              </div>
            </div>
            ...
            <div class="job-info-list">
              <div class="row">
                ...
                <div class="col-sm-8">
                  <span class="ji-main">31/12/2023</span>
                </div>
              </div>
            </div>
          ...
          <div class="company-intro">
            ...
            <ul class="job-add">
              <li>
                ...
                <span>Trụ sở: 212 Phan Đăng Lưu - Hòa Cường Bắc - Hải Châu - Hà Nội </span>
              </li>
              <li>
