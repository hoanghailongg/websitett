...
<div class="container-fluid fluid-nav">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto tnav-left tn-nav">
      <li class="nav-item">
        <a class="nav-link" href="https://itviec.com/dang_viec?utm_source=google&utm_medium=cpc&utm_campaign=customer_page_dsa&gclid=CjwKCAjw9J2iBhBPEiwAErwpedEul-sZh-4mOnLndIaeF_Zig5j8M7Y8pKHbeQ4lqSFJkYzsnx0iURoCXmQQAvD_BwE">Việc Làm IT</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="https://genk.vn/it.php">Tin Tức</a>
      </li>
    ...
    <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
      <li class="nav-item active">
        <a class="nav-link" href="../search.php"><i class="fa fa-search" aria-hidden="true"></i> <span class="hidden-text">Tìm kiếm</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../auth/register/index.php">Đăng Ký</a>
        
      </li>
      <li class="nav-item">
        <a class="nav-link" href="../auth/login/index.php">Đăng Nhập</a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="../#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          VI
          ...
          <div class="job pagi">
              <div class="job-content">
                ...
                <div class="wrap-btn-appl">
                  <a href="../jd-page.php" class="btn btn-appl">Apply Now</a>
                </div>
              </div>
            </div>
            <div class="job pagi">
              <div class="job-content">
                ...
                <div class="wrap-btn-appl">
                  <a href="../jd-page1.php" class="btn btn-appl">Apply Now</a>
                </div>
              </div>
            </div>
            <div class="job pagi">
              <div class="job-content">
                ...
                <div class="wrap-btn-appl">
                  <a href="../jd-page3.php" class="btn btn-appl">Apply Now</a>
                </div>
              </div>
            </div>
            <div class="job pagi">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12 top-employer-wrap">
            <div class="top-employer-item">
              <a href="https://www.fpt-software.com/">
          ...
          <div class="col-md-3 col-sm-6 col-12 top-employer-wrap">
            <div class="top-employer-item">
              <a href="https://mgmtp.hire.trakstar.com/">
                <div class="emp-img-thumb">
                  <img src="../img/nvg-logo.png">
                </div>
          ...
          <div class="col-md-3 col-sm-6 col-12 top-employer-wrap">
            <div class="top-employer-item">
              <a href="https://login.microsoftonline.com/df7fa6cf-2f69-491d-bacd-8caa90484c7b/oauth2/v2.0/authorize?response_type=code&client_id=b0cf1ca7-3577-40d3-8d90-3b567c353659&redirect_uri=https%3a%2f%2fhome.luxoft.com%2f&state=b3142db9cb0b434bbb1175e02cdb2d13&scope=https%3a%2f%2fhome.luxoft.com%2fUser.Read">
                <div class="emp-img-thumb">
                  <img src="../img/luxoft-vietnam-logo.png">
                </div>
          ...
          <div class="col-md-3 col-sm-6 col-12 top-employer-wrap">
            <div class="top-employer-item">
              <a href="https://www.homecredit.vn/">
                <div class="emp-img-thumb">
          ...
          <div class="col-md-3 col-sm-6 col-12 top-employer-wrap">
            <div class="top-employer-item">
              <a href="https://www.techbasevn.com/">
                <div class="emp-img-thumb">
