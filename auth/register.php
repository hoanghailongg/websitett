		...
		<div class="login-header">
			<div class="w-login m-auto">
				...
				<div class="login-right">
					<a href="../index.php" class="btn btn-return">Return Home</a>
				</div>
			</div>
		</div>
		<!-- (end) login header -->
			...
			<div class="w-login m-auto">
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-12 login-main-right">
						...
						<form class="login-form reg-form" action="../backend/auth.php" method="post">
						...
						<div class="reg-info">
						  ...
						  <div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		...
		           		   		<input type="email" class="input form-control-lgin" name="email">
		           		   </div>
		           		</div>
		           		<div class="input-div one">
		           		   <div class="div lg-lable">
		           		    	<h5>Tên tài khoản<span class="req">*</span></h5>
		           		    	<input type="password" class="input form-control-lgin" name="username">
		            	   </div>
		            	</div>
		            	<div class="input-div one">
		           		   <div class="div lg-lable">
		            	...
		            	<div class="reg-info">
						 ...
						 <div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		...
		           		   		<input type="text" class="input form-control-lgin" name="fullname">
		           		   </div>
		           		</div>
		           		 <div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		<h5>Số điện thoại liên hệ<span class="req">*</span></h5>
		           		   		<input type="text" class="input form-control-lgin" name="phone">
		           		   </div>
		           		</div>
		           		 <div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		<h5>Tên công ty<span class="req">*</span></h5>
		           		   		<input type="text" class="input form-control-lgin" name="company">
		           		   </div>
		           		</div>
		           		 <div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		<h5>Địa Chỉ Công Ty<span class="req">*</span></h5>
		           		   		<input type="text" class="input form-control-lgin"  name="address">
		           		   </div>
		           		</div>
		           		<div class="input-div one">
		           		   <div class="div lg-lable">
		           		   		<h5>Thành phố<span class="req">*</span></h5>
		           		   		<input type="text" class="input form-control-lgin"  name="city">
		           		   </div>
		           		</div>
						  <div class="form-group d-block frm-text">
						    <a href="#" class="fg-login d-inline-block"></a>
						    <a href="login.php" class="fg-login float-right d-inline-block">Bạn đã có tài khoản? Đăng Nhập</a>
						  </div>
						 
						 	 <input name="submit" type="submit" class="btn btn-primary float-right btn-login d-block w-100" value="Đăng ký nhà tuyển dụng">
